        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0" style="border-radius: 20px;">
                <div class="card-header bg-white py-3 border-0">
                    <h3 class="card-title font-weight-bold mb-0">Tambah Ruangan Baru</h3>
                </div>
                <div class="card-body px-4 pb-4">
                    <form action="{{ route('rooms.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Ruang Rapat Merpati" required>
                            @error('name')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control border-left-0 @error('capacity') is-invalid @enderror" id="capacity" name="capacity" value="{{ old('capacity') }}" placeholder="Jumlah maksimal orang">
                                @error('capacity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Sebutkan fasilitas ruangan (Proyektor, AC, Whiteboard, dll)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
